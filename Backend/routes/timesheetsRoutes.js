...
router.get('/editable-timesheets', authenticate, getEditableTimesheets);
router.get('/check-submission-block', authenticate, checkSubmissionBlock);
router.get('/export/:id', authenticate, exportTimesheetToCSV);
router.get('/:id', authenticate, getTimesheetById);
router.put('/:id/edit-rejected', authenticate, editRejectedTimesheet);
